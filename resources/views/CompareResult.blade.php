...
@include('layouts.header')
    <div class="container">
        ...
        <label class="choose-inner-fraework">
        <div>
            ...
            FirstChart.data = {
                ...
                datasets: [
                    @for($filltime = 1; $filltime <= count($gradedata); $filltime++) {
                        ...
                        data: first_new_data[{{$filltime-1}}],
                        borderWidth: 1
                    },
                    @endfor
                ]
            ...
            SecondChart.data = {
                ...
                datasets: [
                    @for($filltime = 1; $filltime <= count($gradedata); $filltime++) {
                        type: 'line',
                        label: '第{{((int)$filltime)}}次填寫',
                        data: second_new_data[{{$filltime-1}}],
                        borderWidth: 1
                    },
                    @endfor
                ]
    ...
    <!--視覺化圖形end-->
    @for($filltime = 0; $filltime < count($gradedata); $filltime++ ) <table id="table{{((int)$filltime)+1}}" class="option-table">
        <thead>
