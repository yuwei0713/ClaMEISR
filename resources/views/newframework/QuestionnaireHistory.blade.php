                                                            ...
                                                            <span class="option-size">
                                                                <span class="option-size-adjust">
                                                                    <div class="option-size-inner">
                                                                        ...
                                                                        <input type="radio" name="q{{ $HistoryData[$i]['BigTopicNumber'] }}-{{ $detail['SmTopicNumber'] }}" value="{{ $k + 1 }}-{{ $detail['OptionValue'][$k] }}" class="option-circle" checked disabled>
                                                                        @else
                                                                        <input type="radio" name="q{{ $HistoryData[$i]['BigTopicNumber'] }}-{{ $detail['SmTopicNumber'] }}" value="{{ $k + 1 }}-{{ $detail['OptionValue'][$k] }}" class="option-circle" disabled>
                                                                        @endif
                                                                    </div>
                                                                </span>
                                                            </span>
